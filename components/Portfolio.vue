                ...
                <div class="bl-content">
                    ...
                    <div class="container">
                        ...
                        <div class="row center-align da-thumbs" id="bl-work-items">
                            <!-- Project Starts -->
                            <div class="col s12 m6 l3 xl3" data-panel="panel-1">
                                <a href="#">
									<img class="responsive-img" src="images/projects/exec-networking-logo.jpeg" alt="executive networking" />
									<div class="valign-wrapper"><span class="font-weight-400 uppercase">Executive Networking</span></div>
								</a>
                            </div>
                            <!-- Project Ends -->
                            <!-- Project Starts -->
